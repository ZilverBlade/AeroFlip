...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$cert = New-SelfSignedCertificate -Subject 'CN=AeroFlip Local Elevation' -Type CodeSigningCert -CertStoreLocation 'Cert:\LocalMachine\My' -HashAlgorithm SHA256 -NotAfter (Get-Date).AddYears(30);" ^
